...
Dimensionamento a **118 palavras por minuto** — taxa medida na gravação real.
Faixa de trabalho: 22 a 28 minutos por aula.

### Módulo 1 — Reserva adaptativa: o modelo integrador

| Aula | Palavras | Duração |
|---|---|---|
| [A01 — O erro de contexto](aulas/M1/M1-A01-erro-de-contexto.md) | 3.037 | 26 min |
| [A02 — Síndrome geral de adaptação: Selye](aulas/M1/M1-A02-selye.md) | 3.024 | 26 min |
| [A03 — Aptidão e fadiga](aulas/M1/M1-A03-fitness-fatigue.md) | 3.091 | 26 min |
| [A04 — Carga interna e carga externa](aulas/M1/M1-A04-carga-interna-externa.md) | 3.024 | 26 min |
| [A05 — Mitocôndria: a moeda da conta](aulas/M1/M1-A05-mitocondria.md) | 3.076 | 26 min |
| [A06 — Montando o orçamento de adaptação](aulas/M1/M1-A06-orcamento.md) | 3.111 | 26 min |
| [A07 — Os seis débitos](aulas/M1/M1-A07-seis-debitos.md) | 3.152 | 27 min |
| [A08 — A reserva ao longo da vida](aulas/M1/M1-A08-reserva-ao-longo-da-vida.md) | 3.174 | 27 min |
| [A09 — A lente aplicada](aulas/M1/M1-A09-lente-aplicada.md) | 3.049 | 26 min |

### Módulo 2 — Eixos de regulação no contexto do treino

| Aula | Palavras | Duração |
|---|---|---|
| [A01 — Panorama dos eixos](aulas/M2/M2-A01-panorama-eixos.md) | 2.610 | 22 min |
| [A02 — Eixo HPA](aulas/M2/M2-A02-eixo-hpa.md) | 2.823 | 24 min |
| [A03 — Eixo gonadal masculino](aulas/M2/M2-A03-gonadal-masculino.md) | 3.009 | 26 min |
| [A04 — Eixo gonadal feminino](aulas/M2/M2-A04-gonadal-feminino.md) | 2.978 | 25 min |
| [A05 — Supressão por déficit energético](aulas/M2/M2-A05-deficit-energetico.md) | 2.831 | 24 min |
| [A06 — Eixo tireoidiano](aulas/M2/M2-A06-eixo-tireoidiano.md) | 2.930 | 25 min |
