# M1 · Aula 6 — O orçamento de adaptação: construindo a conta
...
📊 **[SLIDE 1 DE 6]**
*Visual: uma folha de caderno em branco com o título "conta de reserva" e as duas colunas ainda vazias.*
*Teleprompter: (entra direto, tom de quem vai arregaçar a manga)*

Então, cinco aulas eu venho falando de uma conta. Hoje a gente monta ela.

E eu quero começar admitindo uma coisa, para você não esperar o que não vai ter. Essa conta não fecha em número. Não existe uma fórmula em que você bota sono, trabalho, treino e alimentação, aperta o igual, e sai um saldo em unidades.
...
E por que eu começo por aí? Porque o REDs é, na prática, a demonstração mais bem documentada de que existe uma conta única no organismo. Ele mostra, com evidência acumulada, que quando falta energia disponível o corpo não corta um sistema. Ele corta vários, em ordem de prioridade, e todos ao mesmo tempo.
...
Essa é a prova de conceito da conta. E é por isso que a gente vai começar por ela.

---

📊 **[SLIDE 2 DE 6]**
*Visual: a equação da disponibilidade energética escrita de forma simples — energia ingerida menos gasto do exercício, dividida por massa magra.*
*Teleprompter: (tom didático; devagar na definição)*

Vamo entender o conceito de disponibilidade energética, porque quase todo mundo confunde com balanço calórico e não é a mesma coisa.

Balanço calórico é o que entra menos tudo o que sai, e ele te diz se a pessoa vai ganhar ou perder peso.

Disponibilidade energética é outra coisa. É a energia que **sobra para o resto do organismo** depois que o exercício já cobrou a parte dele. Você pega o que a pessoa comeu, subtrai o gasto do exercício, e divide pela massa magra dela.
...
Quer dizer: **peso estável não é prova de que está tudo bem.** E a gente usa peso estável como prova o tempo todo.

E olha como isso conversa com tudo que a gente viu. A disponibilidade energética é, em termos práticos, a entrada do caixa. É o depósito. O treino é um saque grande e visível. E os outros débitos — sono ruim, estresse, doença — não aparecem na equação, mas competem pelo mesmo saldo.
...
📊 **[SLIDE 3 DE 6]**
*Visual: uma lista de sistemas — osso, eixo reprodutivo, imune, humor, reparo, desempenho — com setas todas apontando para o mesmo caixa central.*
*Teleprompter: (tom firme; este é o conceito que amarra o módulo)*

Agora a parte que eu considero a mais importante do módulo inteiro: a lógica de priorização.

Quando falta caixa, o organismo não distribui a escassez igualmente. Ele escolhe. E ele escolhe pela mesma regra que qualquer sistema sob restrição usa: primeiro paga o que mantém você vivo hoje, depois o que mantém você vivo amanhã, e por último o que mantém a espécie.
...
Pois é. Mudou a conta, não o treino.

---

📊 **[SLIDE 5 DE 6]**
*Visual: quatro passos numerados, em tipografia grande, ocupando a tela inteira.*
*Teleprompter: (aterrissagem: ritmo de método, claro e ordenado)*
...
📊 **[SLIDE 6 DE 6]**
*Visual: a folha da conta com um carimbo "hipótese", não "diagnóstico".*
*Teleprompter: (tom de honestidade; desacelera no fechamento)*

Agora os limites, porque eu não quero que você saia daqui com uma ferramenta e sem as bordas dela.

A conta é uma hipótese, não é um diagnóstico. Ela organiza o raciocínio e aponta onde olhar. Ela não substitui investigação. Se o paciente tem sinal de alarme — perda de peso não intencional, febre, sangramento, dor noturna, linfonodo, fadiga de início súbito — a conta espera e a investigação começa.

Segundo limite: ela não tem pesos. Eu não sei te dizer quanto uma noite de cinco horas vale em relação a uma semana de restrição alimentar. Ninguém sabe, e quem te der esse número está inventando. A conta te diz que ambos entram no mesmo caixa, não quanto cada um pesa.

Terceiro limite, e esse é o mais importante eticamente: cuidado para não transformar a conta em culpa. É muito fácil listar os débitos de um paciente e devolver isso para ele como se fosse uma lista de erros dele. "Você dorme mal, você come mal, você trabalha demais." Isso não é cuidado, é cobrança — e o paciente que trabalha em turno e tem dois filhos não escolheu aquela vida por preguiça.

O trabalho não é apontar os débitos. É encontrar, junto com ele, qual débito tem alguma folga, e trabalhar essa folga. Às vezes é meia hora de sono. Às vezes é uma refeição no plantão. Às vezes é só a ordem dos treinos dentro da semana.
...
**Slide 1** — Hoje a gente monta a conta
· Ela não fecha em número — é método de leitura
· O REDs é a demonstração documentada de que a conta existe
· Falta energia e caem osso, ciclo, imune, humor e desempenho juntos
· Caem juntos porque eram pagos do mesmo lugar
Visual: folha de caderno em branco com as colunas vazias.

**Slide 2** — Disponibilidade energética não é balanço calórico
· É o que sobra para o corpo depois que o treino cobrou
· Dá para ter peso estável e caixa baixo ao mesmo tempo
· A fórmula tem erro grande — serve para extremos e para tendência
· Mostrar a conta ao paciente muda mais comportamento que orientação
Visual: a equação escrita de forma simples.

**Slide 3** — A ordem em que o corpo corta
· Primeiro o que dá para adiar: reprodução, osso, reparo, imunidade
· Desempenho é o mais fácil de cortar de todos
· A queixa que traz o paciente é o último item da prioridade dele
· Repor o caixa faz várias coisas voltarem juntas
Visual: sistemas com setas apontando para o mesmo caixa.

**Slide 4** — Eliane, 33 anos, plantonista
· Três queixas de sistemas diferentes ao mesmo tempo
· Quatro débitos grandes e nenhuma entrada organizada
· O treino não era o problema principal
· Cinco meses: mais força, menos gordura, um resfriado contra quatro
Visual: a folha de conta preenchida.

**Slide 5** — Quatro passos
· Some os débitos: treino, trabalho, sono, alimentação, vida, saúde
· Procure as entradas — o silêncio já é diagnóstico
· Monte a hipótese na forma padrão, falsificável
· Teste no débito mais barato de mexer, não no mais óbvio
Visual: quatro passos numerados ocupando a tela.

**Slide 6** — Os limites
· É hipótese, não diagnóstico; sinal de alarme interrompe
· A conta não tem pesos, e quem te der o peso está inventando
· Não transforme a conta em lista de culpas do paciente
· Ela vale mais justamente para quem tem vida difícil
Visual: a folha com carimbo "hipótese".
