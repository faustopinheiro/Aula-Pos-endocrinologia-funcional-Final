# M1 · Aula 8 — Reserva adaptativa ao longo da vida e como ela se esgota
...
📊 **[SLIDE 1 DE 6]**
*Visual: uma linha do tempo da vida com o tamanho do caixa variando — pequeno na infância, grande no adulto jovem, encolhendo depois.*
*Teleprompter: (entra direto)*

Então, até aqui a gente montou a conta como se ela fosse do mesmo tamanho para todo mundo. E não é.

O tamanho desse caixa muda ao longo da vida. E muda de um jeito que você precisa conhecer, porque ele explica coisas que a gente costuma atribuir a outras causas — à disciplina, à genética, à idade em abstrato.

E olha, esse é um dos pontos em que a literatura mais deixa a gente na mão, e vale dizer por quê. A pesquisa de ciência do esporte, como a gente viu lá na primeira aula, foi feita majoritariamente em homens jovens e saudáveis. Quer dizer: justamente nas fases em que o caixa é maior e mais estável.

Adolescente, gestante, mulher em transição menopausal e master acima dos sessenta são exatamente os grupos menos estudados. Então boa parte do que eu vou te dizer hoje tem base fisiológica sólida e base experimental mais fina do que eu gostaria. Eu vou sinalizar onde.

E tem mais: em algumas fases da vida existem débitos que são **obrigatórios**. Não são escolha, não dá para negociar, não dá para tirar da planilha. O corpo vai pagar aquilo primeiro, e o que sobrar é o que você tem para trabalhar.

É o caso do adolescente em estirão. É o caso da mulher em várias fases. É o caso do envelhecimento.

Então hoje a gente vai passar por essas fases olhando duas perguntas em cada uma: qual é o tamanho do caixa aqui, e que débito obrigatório existe nessa fase que eu não posso ignorar.

E antes de entrar nas fases, um aviso sobre como não usar isso. Fase da vida não é destino e não é sentença. Eu não quero que você saia daqui olhando para um paciente de cinquenta e cinco e pensando "o caixa dele é pequeno, vamos com calma". Isso é o erro que eu mais vejo cometerem com paciente mais velho, e ele custa caro, porque subestimular também encolhe o caixa.

O que a fase te diz é onde procurar o débito obrigatório e quanto tempo dar entre estímulos. Não te diz quanto estímulo dar. Essas são decisões diferentes e a gente confunde as duas o tempo todo.

E na segunda metade da aula eu quero fazer outra coisa, que é descrever o percurso. Como é que essa reserva se esgota, passo a passo. Porque ela não some de uma vez. Ela vai baixando, e no caminho ela passa por estados que têm nome e que aparecem no consultório com queixas diferentes.

E eu vou evitar de propósito a palavra que todo mundo usa para o fim desse caminho, que é exaustão. Pelo motivo que a gente viu na segunda aula: aquela palavra veio de um rato que morreu, e ela não descreve o que acontece com o seu paciente.

---

📊 **[SLIDE 2 DE 6]**
*Visual: a curva de velocidade de crescimento com a janela do estirão destacada e a legenda "débito obrigatório".*
*Teleprompter: (tom cuidadoso; aqui tem muito adulto tratando criança como adulto pequeno)*
...
📊 **[SLIDE 3 DE 6]**
*Visual: uma linha do tempo feminina com as três fases — ciclo menstrual, gestação e pós-parto, transição menopausal.*
*Teleprompter: (tom firme; aqui é onde mais se fala sem base)*

Agora a mulher, e aqui eu preciso de você com atenção, porque é o território onde mais se fala com confiança sobre o que a evidência menos sustenta.
...
📊 **[SLIDE 4 DE 6]**
*Visual: dois caixas lado a lado, o dos 25 e o dos 55, com o segundo menor mas com a mesma porta de entrada.*
*Teleprompter: (tom prático; nada de pessimismo aqui)*

Agora o master, que é provavelmente o grosso do seu consultório.
...
📊 **[SLIDE 5 DE 6]**
*Visual: quatro estados em sequência, do saldo saudável até a queda sustentada, com as queixas típicas de cada um embaixo.*
*Teleprompter: (tom de descrição clínica; ritmo mais lento)*
...
📊 **[SLIDE 6 DE 6]**
*Visual: uma tabela de três colunas — fase da vida, débito obrigatório, ajuste de conduta.*
*Teleprompter: (aterrissagem; desacelera no fechamento do módulo)*

Então o que muda na conduta, por fase.

No adolescente: garanta dia sem treino organizado, proteja o sono, e trate dor persistente como achado e não como passagem. E, se ele está em vários times ao mesmo tempo, alguém precisa contar a conta inteira, porque cada treinador só enxerga a parte dele.

Na mulher: pergunte sobre o ciclo em toda consulta, use ele como marcador e não como calendário de treino, e na gestação e no pós-parto trate a expectativa com o mesmo cuidado com que você trata a carga.

E vale dizer o que não muda em nenhuma fase, porque isso também é orientação. Em todas elas, sono continua sendo entrada. Em todas, disponibilidade energética continua sendo entrada. Em todas, infecção de repetição continua sendo alerta. E em todas, a mesma sessão continua sendo um evento diferente em cada corpo.

O que muda com a fase é o tamanho do caixa e qual débito obrigatório está rodando. A lógica não muda.

No master: preserve intensidade, reduza densidade, e não confunda envelhecer com adoecer.

E em todas as fases, a mesma pergunta de fundo: que débito obrigatório está rodando aqui que eu não posso tirar, e quanto sobra depois dele?

Com essa aula, a gente fechou a construção do modelo. Você tem o conceito, tem a distinção entre o que você prescreve e o que o corpo recebe, tem o substrato físico, tem o método de montar a conta, tem os seis débitos e tem a variação por fase da vida.

Na próxima aula, que fecha o módulo, a gente não vai acrescentar teoria nenhuma. A gente vai pegar três pacientes que chegam com exatamente a mesma frase — "estou cansado e não estou evoluindo" — e percorrer o raciocínio nos três. E você vai ver os três terminarem em lugares completamente diferentes.

Porque é isso que essa lente faz. Ela não te dá a resposta. Ela te dá o percurso.
...
2. Milewski MD, Skaggs DL, Bishop GA, et al. Chronic lack of sleep is associated with increased sports injuries in adolescent athletes. *J Pediatr Orthop.* 2014;34(2):129-133. PMID: 25028798
3. Cowley ES, Olenick AA, McNulty KL, Ross EZ. "Invisible Sportswomen": The Sex Data Gap in Sport and Exercise Science Research. *Women Sport Phys Act J.* 2021;29(2):146-151. doi:10.1123/wspaj.2021-0028
...
**Slide 1** — O caixa muda de tamanho
· A conta não é do mesmo tamanho a vida toda
· Algumas fases têm débito obrigatório, não negociável
· Segunda metade: como a reserva se esgota, passo a passo
· Sem usar a palavra que veio de um rato que morreu
Visual: linha do tempo da vida com o caixa variando.

**Slide 2** — Adolescente: crescer é um débito
· Recuperação excelente e uma conta obrigatória rodando 24 horas
· Tolerância não é ausência de custo
· Abandono do esporte na adolescência é desfecho clínico
· Dor de crescimento é exclusão, não explicação pronta
Visual: curva de velocidade de crescimento com o estirão destacado.

**Slide 3** — A mulher: marcador, não calendário
· O ciclo altera fisiologia; o efeito sobre desempenho é pequeno e mal estudado
· Use o ciclo como marcador de disponibilidade energética
· Gestação e pós-parto: o erro é a expectativa, não o volume
· Transição menopausal: a conta mudou e a dose não mudou junto
Visual: linha do tempo feminina com as três fases.

**Slide 4** — Master: intensidade preservada, densidade reduzida
· O caixa encolhe e principalmente demora mais para repor
· O erro comum não é treinar demais, é manter a frequência dos 25
· O erro oposto: caminhada e elástico é tratar idade como doença
· Espalhar, não reduzir
Visual: dois caixas, o dos 25 e o dos 55.

**Slide 5** — O percurso do esgotamento
· Saldo saudável: a fadiga some dentro da semana
· Acúmulo funcional: normal, se vier recuperação depois
· Acúmulo não funcional: caem juntos desempenho, sono, humor, ciclo, imunidade
· Queda sustentada: raro, diagnóstico de exclusão, não carimbe
Visual: quatro estados em sequência com as queixas típicas.

**Slide 6** — A pergunta de fundo
· Adolescente: dia sem treino, sono, dor não normalizada
· Mulher: ciclo em toda consulta, expectativa no pós-parto
· Master: preserve intensidade, reduza densidade
· Que débito obrigatório roda aqui, e quanto sobra depois dele?
Visual: tabela fase / débito obrigatório / ajuste.
