# M1 · Aula 3 — Fitness-fatigue e carga alostática: dois modelos, uma conta
...
📊 **[SLIDE 1 DE 6]**
*Visual: a curva de três fases riscada, e ao lado duas curvas separadas começando a se desenhar.*
*Teleprompter: (entra direto, retomando a aula anterior)*

Então, na aula passada a gente derrubou uma coisa e eu não posso te deixar sem nada no lugar. Se a curva de três fases não serve como mapa de treino, o que é que explica o que acontece entre uma sessão e a próxima?

Porque alguma coisa acontece, né. Você treina hoje, amanhã está pior, depois de amanhã está igual, e daqui a quatro dias está melhor. Isso é real, todo mundo sente, e precisa de explicação.
...
📊 **[SLIDE 2 DE 6]**
*Visual: duas curvas sobrepostas — aptidão, baixa e lenta; fadiga, alta e rápida — e a linha do saldo entre elas.*
*Teleprompter: (tom didático, mais devagar; é o mecanismo central)*

Então vamo entender por que o taper funciona, porque está tudo aqui.

As duas curvas têm comportamentos diferentes. A fadiga sobe muito e some rápido. A aptidão sobe pouco e some devagar.

Repete isso comigo, que é o coração da aula: a fadiga é grande e curta. A aptidão é pequena e longa.

Aí você reduz a carga por dez, quatorze dias. O que acontece? A fadiga, que some rápido, desaba. A aptidão, que some devagar, mal se mexe. E o saldo, que é o que você mede, sobe. O atleta não ficou mais apto na semana do taper — ele ficou menos cansado, e aí apareceu a aptidão que já estava lá.
...
📊 **[SLIDE 3 DE 6]**
*Visual: o mesmo gráfico do slide anterior, agora com um ponto de interrogação sobre os parâmetros individuais.*
*Teleprompter: (virada de tom; aqui é honestidade metodológica, não desânimo)*

Agora eu preciso te dizer onde esse modelo quebra, porque se eu te entregar ele inteiro e bonito você vai sair daqui achando que dá para calcular, e não dá.

Esse modelo é uma equação. Ele tem parâmetros: quanto cada sessão deposita de aptidão, quanto deposita de fadiga, em quanto tempo cada uma decai. E a ideia original era que você medisse esses parâmetros no seu atleta e conseguisse prever o desempenho dele.

Só que quando foram testar isso a sério, o negócio não se sustentou.

Os trabalhos que avaliaram as limitações do modelo mostraram que ele é mal condicionado, que os parâmetros de aptidão e de fadiga não são bem identificáveis — quer dizer, você acha valores que encaixam nos dados, mas não são valores estáveis nem interpretáveis — e que há padrão de superajuste. E teve um achado que é quase irônico: acrescentar os parâmetros de fadiga não melhorava de forma relevante a capacidade de predição do modelo.
...
📊 **[SLIDE 4 DE 6]**
*Visual: linha do tempo de oito semanas com os tempos de prova do paciente e a marcação da semana de recuo.*
*Teleprompter: (tom de história)*

Deixa eu te contar um caso que é quase uma demonstração do modelo.

O Otávio, trinta e nove anos, corre há uns seis anos, fez três maratonas. Chegou em maio irritado, e a primeira coisa que ele falou foi:

> *"Eu tô treinando mais do que nunca e tô correndo pior do que ano passado. Alguma coisa tá errada comigo."*
...
O que a gente fez foi quase nada. Dez dias com o volume reduzido pela metade, mantendo duas sessões curtas de intensidade só para não desacostumar o corpo, e nenhuma prova, nenhum teste, nenhum cronômetro nesse período.

No décimo primeiro dia, ele fez o mesmo treino de ritmo que vinha fazendo. E melhorou quase quarenta segundos por quilômetro em relação ao mês anterior.

E ele ficou bravo, viu. Genuinamente bravo. Falou: *"Quer dizer que eu perdi cinco meses?"*
...
📊 **[SLIDE 5 DE 6]**
*Visual: as duas curvas de Banister dentro de um retângulo pequeno rotulado "treino", e em volta, um retângulo maior rotulado "a vida".*
*Teleprompter: (tom conceitual; a virada da aula está aqui)*

Agora presta atenção nessa parte, porque é aqui que essa aula encontra a primeira.

O modelo das duas curvas tem um problema que não é de matemática. É de escopo. Ele só enxerga treino.

Naquela equação, a única coisa que deposita fadiga é a sessão. A única coisa que deposita aptidão é a sessão. A noite mal dormida não entra. O plantão não entra. A briga em casa não entra. A dieta restritiva não entra. A virose não entra.

E você já sabe, das duas primeiras aulas, que todas essas coisas entram no corpo do paciente, queira o modelo ou não.
...
📊 **[SLIDE 6 DE 6]**
*Visual: uma folha de caderno com três colunas simples — data, o que fez, como acordou — e a marcação dos dez dias fáceis.*
*Teleprompter: (aterrissagem: prático e rápido; desacelera no fechamento)*
...
1. Banister EW, Calvert TW, Savage MV, Bach TM. A systems model of training for athletic performance. *Aust J Sports Med.* 1975;7(3):57-61. (periódico não indexado no PubMed)
2. Hellard P, Avalos M, Lacoste L, Barale F, Chatard JC, Millet GP. Assessing the limitations of the Banister model in monitoring training. *J Sports Sci.* 2006;24(5):509-520. PMCID: PMC1974899
...
4. Kiely J. Periodization Theory: Confronting an Inconvenient Truth. *Sports Med.* 2018;48(4):753-764. PMCID: PMC5856877

---

## Roteiro Gamma.app

**Slide 1** — Duas coisas ao mesmo tempo
· Se a curva de três fases caiu, o que explica o entre-sessões?
· Banister, anos 70: o treino deposita aptidão e fadiga juntas
· Você nunca vê aptidão nem fadiga — vê o saldo
· Piorar após aumentar carga pode ser sinal de plano funcionando
Visual: a curva de três fases riscada, duas curvas nascendo ao lado.

**Slide 2** — A fadiga é grande e curta; a aptidão é pequena e longa
· Por isso o taper funciona: some o cansaço, sobra o ganho
· Explica a semana doente que "fez bem"
· Explica o iniciante que voa e o experiente que empaca
· Medir desempenho no dia errado gera conclusão errada de plano
Visual: duas curvas sobrepostas e a linha do saldo.

**Slide 3** — Ótima metáfora, péssima calculadora
· Modelo mal condicionado, parâmetros não identificáveis
· Superajuste; o componente fadiga não melhorou a predição
· Mesmo erro da aula anterior, em outra roupagem
· A pergunta certa: aptidão parou de subir ou fadiga parou de descer?
Visual: o gráfico com interrogação sobre os parâmetros.

**Slide 4** — Otávio, 39 anos
· 50 para 75 km/semana, cinco meses sem uma semana leve
· Tempo piorando fazia ele treinar mais — o ciclo se retroalimenta
· Dez dias com metade do volume, sem cronômetro
· 40 segundos por quilômetro melhor no décimo primeiro dia
Visual: linha do tempo de oito semanas com a semana de recuo marcada.

**Slide 5** — O modelo só enxerga o treino
· Na equação, plantão, briga e dieta não entram
· O paciente não mora dentro do retângulo do treino
· Carga alostática: tudo deposita custo, no mesmo lugar
· Fadiga é o recibo do estímulo, não um defeito a eliminar
Visual: as curvas dentro de um retângulo "treino", dentro de outro "a vida".

**Slide 6** — Dez dias fáceis é o exame mais barato
· Janela de 7 a 10 dias; um dia ruim é ruído
· Melhorou = era saldo · não melhorou = investigue com razão
· Registrar carga da semana e nota de como acorda
· Sinal de alarme não é problema de saldo — dez dias fáceis vira atraso
Visual: folha de caderno com três colunas e os dez dias marcados.
