...
## O casco intelectual: RESERVA ADAPTATIVA

Um nome amplo vira commodity se a grade for genérica. O que impede isso é um
conceito integrador que atravessa **todos** os módulos e que o aluno leva
embora como forma de raciocinar — não como lista de conteúdos.
...
Ancoragem científica: carga alostática, modelo fitness-fatigue, síndrome
geral de adaptação revisitada, disponibilidade energética relativa no esporte
(RED-S), overreaching não funcional, monitoramento de carga interna x externa.

**É esta a lente.** É o que faz a pós ser reconhecível como "do Fausto":
conectar o que os outros separam. Se um módulo não puxa pelo menos dois
sistemas que pareciam separados, o módulo está errado — mesma régua de ouro
do conteúdo.
...
1. **Ler carga total, não só carga de treino** — construir a conta de
   reserva adaptativa de um indivíduo e identificar de onde vem o déficit.
...
## Régua de tom e blindagem ética

Herdada integralmente da marca, aplicada ao material didático:

- Ancoragem na definição de saúde da OMS — bem-estar pleno, não só ausência
  de doença.
- **Linguagem condicional** onde a evidência é associação, não causa.
- **Nunca comparar ou citar outras especialidades.** Falar pela experiência
  do atleta, não pela disputa entre profissões.
- Sem promessa de cura ou de resultado.
